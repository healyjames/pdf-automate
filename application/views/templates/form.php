<div class="section section-a">
            <div class="element">
                ...
                <select name="country" id="country">
                    ...
                    <option value="Korea, Democratic People's Republic of">Korea, Democratic People's Republic of (North)</option>
                    <option value="Korea, Republic of">Korea, Republic of (South)</option>
            ...
            <div class="element">
                ...
                <select name="visatype" id="visatype">
                    ...
                    <option style="display:none"> </option>
                    <option value="Regular Visa">Regular Visa</option>
                    <option value="Partial Service">Partial Service</option>
                    <option value="Electronic (eVisa)">Electronic (eVisa)</option>
                    <option value="Entry Visa">Entry Visa</option>
                    <option value="Employment Visa">Employment Visa</option>
                    <option value="Work Permit">Work Permit</option>
                    <option value="Tourist Card">Tourist Card</option>
                    <option value="Social Cultural Visa">Social Cultural Visa</option>
